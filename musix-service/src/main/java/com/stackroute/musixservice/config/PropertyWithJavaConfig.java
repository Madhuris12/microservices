...
public class PropertyWithJavaConfig implements ApplicationListener<ContextRefreshedEvent> {
    private static final Logger logs=Logger.getLogger(PropertyWithJavaConfig.class);
    private TrackRepository trackRepository;

    @Autowired
    public PropertyWithJavaConfig(TrackRepository trackRepository) {
